package com.cindyu.installed_apps;
...
/** InstalledAppsPlugin */
public class InstalledAppsPlugin implements MethodCallHandler, PluginRegistry.ViewDestroyListener {

  /**
   * Plugin registration.
   */
  public static void registerWith(Registrar registrar) {
    final MethodChannel channel = new MethodChannel(registrar.messenger(), "cindyu.com/installed_apps");
    InstalledAppsPlugin plugin = new InstalledAppsPlugin(registrar.activity());
  ...
  private InstalledAppsPlugin(Activity activity) {
